    ...
    protected String doInBackground(String... voids) {
        ...
        if(type.equals("login")) {
            try {
                ...
                OutputStream outpuStream = httpURLConnection.getOutputStream();
                BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(outpuStream, "UTF-8"));
                String post_data = URLEncoder.encode("brukernavn", "UTF-8")+"="URLEncoder.encode(brukernavn, "UTF-8")+"&"
